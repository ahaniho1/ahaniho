    ...
    <div style={{ background: '#F8FAFC', minHeight: '100vh' }}>
      <section style={{ background: 'linear-gradient(135deg, #EFF6FF, #F8FAFC)', padding: '64px 0 48px', textAlign: 'center' }}>
        <div className="container">
          ...
          <p className="text-gray-500 text-lg">Rules and guidelines for using AHA NIHO</p>
        </div>
      </section>
      <section className="section-sm">
        <div className="container" style={{ maxWidth: '800px' }}>
          <div className="card" style={{ padding: '36px', fontSize: '15px', lineHeight: '1.8', color: '#334155' }}>
            ...
            <p className="mb-6">By accessing and using AHA NIHO, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</p>
            <h2 className="text-xl font-bold text-gray-900 mb-3">2. Content</h2>
            <p className="mb-6">Content published on AHA NIHO is for educational and informational purposes only. Authors are responsible for their published articles.</p>
            ...
            <p className="mb-6">Authors retain rights to their content. By publishing on AHA NIHO, you grant us a license to display your content on our platform.</p>
            <h2 className="text-xl font-bold text-gray-900 mb-3">5. Limitation of Liability</h2>
            <p className="mb-6">AHA NIHO is provided as-is. We are not liable for any damages arising from the use of our platform.</p>
